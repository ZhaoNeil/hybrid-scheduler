...
cc_binary(
    name = "hybrid_agent",
    srcs = [
        "schedulers/hybrid/hybrid_agent.cc",
        "schedulers/hybrid/hybrid_scheduler.cc",
        "schedulers/hybrid/hybrid_scheduler.h",
        "schedulers/hybrid/cfs_scheduler.cc",
        "schedulers/hybrid/cfs_scheduler.h",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
...
cc_binary(
    name = "short_queue_agent",
    srcs = [
        "schedulers/short_queue/short_queue_agent.cc",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
        ":short_queue_scheduler",
        ":topology",
        "@com_google_absl//absl/debugging:symbolize",
        "@com_google_absl//absl/flags:parse",
    ],
...
cc_library(
    name = "short_queue_scheduler",
    srcs = [
        "schedulers/short_queue/short_queue_scheduler.cc",
    ],
    hdrs = [
        "schedulers/short_queue/short_queue_scheduler.h",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
